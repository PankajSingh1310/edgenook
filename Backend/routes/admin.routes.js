...
const { adminLogin, adminLogout, userLists, createCourse, updateCourse, deleteCourse, deleteUser, adminProfile, verifyEnrollment, getPendingEnrollments, getEnrollments } = require("../cotrollers/admin.controller");
...
router.get('/enrollments', isAdmin, getEnrollments);
